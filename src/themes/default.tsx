export default {
    ...
    alert: {
      ...
      none: 'bg-gray-50 text-gray-800 dark:bg-gray-700 dark:text-gray-300',
    ...
    button: {
      ...
      size: {
        ...
        normal: 'px-4 py-2 rounded-lg text-sm',
        mini: 'px-3 py-1 rounded-md text-sm',
        icon: {
      ...
      outline: {
        base: 'text-purple-600 border-purple-300 border dark:text-gray-400 focus:outline-none',
        active:
